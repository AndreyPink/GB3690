...
{
    int rank = (int)Math.Pow(10, count - 3); //создаем число 10 в степени (count-3)
    int num3 = num / rank % 10; //отделяем от num лишние разряды и находим последнюю цифру. Так же округляем ее до целого.
